...
export const schemas: Record<string, EntitySchema> = {
  ...
  category: {
    ...
    fields: [
      ...
      { name: "isCustom", type: "boolean", label: "Is Custom" },
    ],
    zodSchema: z.object({
      name: z.string(),
  ...
  recurringTransaction: {
    ...
    fields: [
      ...
      { name: "frequency", type: "string", label: "Frequency", required: true },
      { name: "nextDate", type: "number", label: "Next Date", required: true },
      { name: "accountId", type: "string", label: "Account", required: true },
  ...
  savingsGoal: {
    ...
    fields: [
      ...
      { name: "currency", type: "string", label: "Currency", required: true },
      { name: "deadline", type: "number", label: "Deadline" },
      { name: "icon", type: "string", label: "Icon" },
      { name: "color", type: "string", label: "Color" },
      { name: "accountId", type: "string", label: "Linked Account" },
    ],
    zodSchema: z.object({
      name: z.string(),
