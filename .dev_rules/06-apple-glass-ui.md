...
```tsx
<div
  className="bg-[oklch(98%_0.01_240_/_0.6)] backdrop-blur-xl border border-[oklch(90%_0.02_240_/_0.3)] shadow-lg"
>
  Content
</div>
```
...
export function GlassCard({ className, intensity = "medium", children, ...props }: GlassCardProps) {
  ...
  const bgOpacityMap = {
    ...
    medium: "bg-[oklch(98%_0.01_240_/_0.6)] dark:bg-[oklch(20%_0.02_260_/_0.7)]",
...
<GlassCard intensity="medium" className="p-6 max-w-md mx-auto">
  ...
  <p className="text-muted-foreground mt-2">
    Этот текст хорошо читается на полупрозрачном фоне благодаря правильному контрасту.
  </p>
</GlassCard>
```
